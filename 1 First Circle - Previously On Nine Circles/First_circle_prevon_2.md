...
On the other hand, obtaining predictions is quite a bit clunky (*mice* does not even have a *predict* function), and we discuss this in more detail in The Second Circle: Logistic Regression, Part Three.
